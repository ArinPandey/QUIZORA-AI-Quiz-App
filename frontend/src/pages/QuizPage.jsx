...
const QuizPage = () => {
    ...
    const StartScreen = () => (
        <div className="min-h-screen bg-lime-600 flex items-center justify-center p-4 mt-[-70px]">
    ...
    */}
    ...
    const QuizScreen = () => {
        ...
        return (
            <div className="min-h-[calc(100vh-64px)] bg-[#92B4EC] py-8 px-4 flex items-center mt-[-30px]">
    ...
    const ResultsScreen = () => {
        ...
        return (
            <div className="flex items-center justify-center p-4 min-h-[calc(100vh-64px)] bg-[#FF5D5D] py-12 px-4 mt-[-35px] overflow-hidden">
                    ...
                    <div className="bg-white rounded-[2rem] shadow-2xl p-8 mb-8 text-center border border-white/20 backdrop-blur-sm relative overflow-hidden">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                            ...
                            <div className="text-left flex-1">
                                <h1 className={`text-4xl font-unbounded mb-2 ${feedback.color}`}>{feedback.msg}</h1>
